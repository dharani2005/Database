...
public class CityDAOJDBC implements CityDAO {
    ...
    public City add(City city) {
        ...
        try (Connection connection = MySqlConnection.getConnection();
            ...
            e.printStackTrace();
            System.out.println("city with this name is not added" + e.getMessage());
        }
    ...
    public City update(City city) {
        ...
        try (Connection connection = MySqlConnection.getConnection();
            ...
            e.printStackTrace();
            System.out.println("city is not updated" + e.getMessage());
        }
        return city;
    }
    ...
    public int delete(City city) {
        ...
        try (Connection connection = MySqlConnection.getConnection();
            ...
            e.printStackTrace();
            System.out.println("city is not deleted" + e.getMessage());
        }
        return rowDeleted;
    }
}
